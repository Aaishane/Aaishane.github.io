...
$query= "SELECT * FROM  product WHERE prod_code='$product_id'";
...
<head>
  ...
  <link rel="stylesheet" href="styles/prodDescription.css">
   ...
   <!--Header: Showear logo, shoppingcart&account icon-->
    <div class="header">
      <div class="left-section">
        <a href="homepage.php">
        <img  class="shoewear-logo" src="icons/logo-shoewear.png">
        </a>
      </div>
      ...
      <div class="cart-icon-container">
          <a href="cart.php">
          <img class="cart-icon" src="icons/cart-logo.png">
        ...
        <div class="user-icon-container">
          <a href="form.php">
          <img class="user-icon" src="icons/user-logo.png">
